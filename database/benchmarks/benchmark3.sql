...
where
    before_proteins.chain_id = 'A' ORDER BY after_proteins.pdb_code limit 100;
...
from
    ...
    inner join sequences on sequences.sequence_id = before_proteins.sequence_id
where
    before_proteins.chain_id = 'B' ORDER BY after_proteins.chain_id limit 100;
...
from
    ...
    inner join sequences on sequences.sequence_id = before_proteins.sequence_id
where
    before_proteins.chain_id = 'C' ORDER BY before_proteins.pdb_code limit 100;
