...
if __name__ == "__main__":
    ...
    for ending in file_endings:
        # Opening JSON file
        f = open(os.path.join(dirname, '../../data/filter/filter_output.json.d/filter_output.json'+ f'{ending:03d}'))
        ...
        for i in data:
            ...
            if not check_pdb_code_and_chain_id(pdb_code, chain_id):
                sys.exit(f"Unexpected format of pdb_code ('{pdb_code}') and chain_id ('{chain_id}')")
            ...
            if not cur.fetchone()[0]:
                ...
                if DEBUG:
                    print(f"Duplicate! pdb_code = '{pdb_code}', chain_id = '{chain_id}")
