...
private:
    ...
    bool parseQuery(const hsql::SelectStatement *selectStatement, bool countOnly, int page, int pageSize);
...
public:
    ...
    bool ConvertQuery(const string &query, bool countOnly, int page = 0, int pageSize = 100);
