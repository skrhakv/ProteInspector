...
export class SuperpositionService {
    ...
    private getChainEntries(plugin: PluginUIContext) {
    ...
    private async superposeChains(plugin: PluginUIContext) {
    ...
    private async transform(plugin: PluginUIContext, s: StateObjectRef<PluginStateObject.Molecule.Structure>, matrix: Mat4, coordinateSystem?: SymmetryOperator) {
